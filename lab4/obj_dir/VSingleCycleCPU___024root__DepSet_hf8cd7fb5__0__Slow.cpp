...
VL_ATTR_COLD void VSingleCycleCPU___024root___eval_initial(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__ALUMEM 
        = vlSelf->SingleCycleCPU__DOT__ALUMEM;
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__memReadMEM 
        = vlSelf->SingleCycleCPU__DOT__memReadMEM;
}
...
VL_ATTR_COLD void VSingleCycleCPU___024root___dump_triggers__act(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(2U)) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @([changed] SingleCycleCPU.ALUMEM or [changed] SingleCycleCPU.memReadMEM)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VSingleCycleCPU___024root___dump_triggers__nba(VSingleCycleCPU___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(2U)) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @([changed] SingleCycleCPU.ALUMEM or [changed] SingleCycleCPU.memReadMEM)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void VSingleCycleCPU___024root___ctor_var_reset(VSingleCycleCPU___024root* vlSelf) {
    ...
    vlSelf->SingleCycleCPU__DOT__muxPC = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__memDataOut = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__muxALUB = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__PCID = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__instID = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__PCEX = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__dataR1EX = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__dataR2EX = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__immEX = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__PCMEM = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__dataR2MEM = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__ALUMEM = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__branchAddrMEM = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__PCplus4WB = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__memDataWB = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__ALUWB = VL_RAND_RESET_I(32);
    vlSelf->SingleCycleCPU__DOT__ALUCtl = VL_RAND_RESET_I(4);
    vlSelf->SingleCycleCPU__DOT__memtoRegEX = VL_RAND_RESET_I(2);
    vlSelf->SingleCycleCPU__DOT__memtoRegMEM = VL_RAND_RESET_I(2);
    vlSelf->SingleCycleCPU__DOT__memtoRegWB = VL_RAND_RESET_I(2);
    vlSelf->SingleCycleCPU__DOT__ALUOpEX = VL_RAND_RESET_I(3);
    vlSelf->SingleCycleCPU__DOT__branchEX = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__memReadEX = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__memWriteEX = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__regWriteEX = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__ALUSrcBEX = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__addrSrcAEX = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__addrSrcBEX = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__branchMEM = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__memReadMEM = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__memWriteMEM = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__regWriteMEM = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__zeroMEM = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__regWriteWB = VL_RAND_RESET_I(1);
    vlSelf->SingleCycleCPU__DOT__instEX = VL_RAND_RESET_I(5);
    vlSelf->SingleCycleCPU__DOT__instMEM = VL_RAND_RESET_I(5);
    vlSelf->SingleCycleCPU__DOT__instWB = VL_RAND_RESET_I(5);
    vlSelf->SingleCycleCPU__DOT__func7n3 = VL_RAND_RESET_I(4);
    ...
    vlSelf->SingleCycleCPU__DOT__m_Control__DOT__ctrl = VL_RAND_RESET_I(12);
    for (int __Vi0 = 0; __Vi0 < 128; ++__Vi0) {
    ...
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__ALUMEM = VL_RAND_RESET_I(32);
    vlSelf->__Vtrigrprev__TOP__SingleCycleCPU__DOT__memReadMEM = VL_RAND_RESET_I(1);
