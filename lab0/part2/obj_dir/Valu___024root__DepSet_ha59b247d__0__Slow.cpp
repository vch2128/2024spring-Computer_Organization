...
#endif
                VL_FATAL_MT("alu.v", 2, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Valu___024root___ctor_var_reset(Valu___024root* vlSelf) {
    ...
    vlSelf->alu__DOT__c1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__c2 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__c3 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__b1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__b2 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__b3 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__add2__DOT__s1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__add3__DOT__s1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__add4__DOT__s1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__sub2__DOT__s1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__sub3__DOT__s1 = VL_RAND_RESET_I(1);
    vlSelf->alu__DOT__sub4__DOT__s1 = VL_RAND_RESET_I(1);
